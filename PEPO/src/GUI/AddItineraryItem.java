 ...
 * @author hongwei
 */
public class AddItineraryItem extends javax.swing.JDialog {

    Itinerary myItinerary;
    /** Creates new form AddItineraryItem */
    public AddItineraryItem(java.awt.Dialog parent, boolean modal, Itinerary pl) {
        super(parent, modal);
        initComponents();
        myItinerary = pl;
        FromHour.setSelectedIndex(8);
        ToHour.setSelectedIndex(9);
    }
    ...
    FromHour.setFont(new java.awt.Font("Ubuntu", 0, 11));
    ...
    StartTimeLabel.setBounds(20, 110, 50, 19);
    ...
    AddBudgetCategoryBackground.add(StartTimeLabel1);
    StartTimeLabel1.setBounds(20, 80, 50, 19);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                AddItineraryItem dialog = new AddItineraryItem(new javax.swing.JDialog(), true,null);
