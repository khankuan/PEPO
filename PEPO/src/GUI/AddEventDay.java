 ...
 * @author kuan
 */
public class AddEventDay extends javax.swing.JDialog {

    /** Creates new form AddEventDay */
    public AddEventDay(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        ItineraryLabel.setBounds(339, 14, 183, 19);

        EditItineraryButton.setFont(new java.awt.Font("Ubuntu", 0, 11));
    ...
    NotesTextArea.setFont(new java.awt.Font("Ubuntu", 0, 14));
...
layout.setHorizontalGroup(
    ...
    private void DoneButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DoneButtonActionPerformed
        if (DescriptionText.getText().length() == 0){
            JOptionPane.showMessageDialog(this, "Oops, description needed...", "Description needed", JOptionPane.PLAIN_MESSAGE);  
            DescriptionText.grabFocus();
            return;
        }
        GregorianCalendar start = new GregorianCalendar();
        start.setTime(StartCalendar.getDate());
        String h = (String)StartHour.getSelectedItem();
        ...
        h = (String)EndHour.getSelectedItem();
        if (h.contains("am"))
            end.set(GregorianCalendar.AM_PM,GregorianCalendar.AM);
        else 
        ...
        end.set(GregorianCalendar.HOUR, Integer.parseInt(h));
        ...
        if (start.after(end)){
            JOptionPane.showMessageDialog(this, "Oops, dates seems to be wrong...", "Wrong date...", JOptionPane.PLAIN_MESSAGE);
            return;
        } else {
            try {
                LogicController.addEventDayWithItinerary(myEvent, DescriptionText.getText(), NotesTextArea.getText(), start.getTime(), end.getTime(), pl);
                this.dispose();
            } catch (Exception ex) {
                Logger.getLogger(AddEventDay.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }//GEN-LAST:event_DoneButtonActionPerformed

    Itinerary pl = new Itinerary();
    private void EditItineraryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditItineraryButtonActionPerformed
        ViewItinerary viewpl = new ViewItinerary(this, true, pl);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                AddEventDay dialog = new AddEventDay(new javax.swing.JFrame(), true);
