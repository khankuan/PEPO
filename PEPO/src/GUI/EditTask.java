...
public class EditTask extends javax.swing.JDialog {
    ...
    public EditTask(java.awt.Frame parent, boolean modal,Task t) {
        super(parent, modal);
        initComponents();
        
        task = t;
        DescriptionText.setText(task.getDescription());
        PriorityDropDown.setSelectedIndex(task.getPriority());
        GregorianCalendar d = new GregorianCalendar();
        d.setTime(task.getDate());
        DeadlineHour.setSelectedIndex(d.get(GregorianCalendar.HOUR_OF_DAY));
        DeadlineMinute.setSelectedItem((d.get(GregorianCalendar.MINUTE)+""));
        DeadlineCalendar.setDate(t.getDate());
        if (task.getAlert() != null){
            AlertButton.setText("Alert");
            AlertButton.setForeground(Color.BLACK);
            d.setTime(task.getAlert());
            AlertHour.setSelectedIndex(d.get(GregorianCalendar.HOUR_OF_DAY));
            AlertMinute.setSelectedItem((d.get(GregorianCalendar.MINUTE)+""));
            AlertCalendar.setDate(t.getAlert());  
            alerton = true;
        } else {
        ...
        if (t.getEvent() != null)
            EventDropDown.setSelectedItem(t.getEvent().getTitle());
    }
    ...
    private void initComponents() {
        ...
        Background.add(DescriptionLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 90, 30));

        PriorityLabel.setFont(new java.awt.Font("Ubuntu", 1, 14)); // NOI18N
    ...
    DeadlineLabel1.setFont(new java.awt.Font("Ubuntu", 1, 14)); // NOI18N
    ...
    private void DoneButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DoneButtonActionPerformed
        ...
        String h = (String)DeadlineHour.getSelectedItem();
        ...
        try {
            LogicController.setTaskPriority(task, PriorityDropDown.getSelectedIndex());
            LogicController.setTaskDescription(task, DescriptionText.getText());
            LogicController.setTaskDate(task, start.getTime());
        if (EventDropDown.getSelectedIndex() == 0)
            LogicController.setTaskEvent(task, null);
        else 
            LogicController.setTaskEvent(task, LogicController.getEventList().get(EventDropDown.getSelectedIndex()-1));
        } catch(Exception ex){
        ...
        if (alerton){
            ...
            GregorianCalendar alert = new GregorianCalendar();
            alert.setTime(AlertCalendar.getDate());

            alert.set(GregorianCalendar.HOUR_OF_DAY, AlertHour.getSelectedIndex());
            alert.set(GregorianCalendar.MINUTE, Integer.parseInt((String)AlertMinute.getSelectedItem()));
            alert.set(GregorianCalendar.SECOND,0);
            alert.set(GregorianCalendar.MILLISECOND,0); 
            if (task.getAlert() != null && !task.getAlert().equals(alert.getTime()))
                LogicController.deleteTaskAlert(task);
            LogicController.addTaskAlert(task, alert.getTime());  
        } else {
            LogicController.deleteTaskAlert(task);
        }
    ...
    private void DescriptionTextKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DescriptionTextKeyTyped
        if (evt.getKeyChar() == 10){
            ...
            if (alerton){
                ...
                alert.set(GregorianCalendar.HOUR_OF_DAY, AlertMinute.getSelectedIndex());
                alert.set(GregorianCalendar.MINUTE, Integer.parseInt((String)AlertMinute.getSelectedItem()));
                alert.set(GregorianCalendar.SECOND,0);
                alert.set(GregorianCalendar.MILLISECOND,0); 
                if (task.getAlert() != null && !!task.getAlert().equals(alert.getTime()))
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                EditTask dialog = new EditTask(new javax.swing.JFrame(), true,null);
